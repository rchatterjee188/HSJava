 ...
 *  @author Kevin Wayne
 */
public final class RC_Picture implements ActionListener {
   ...
   /**
     ...
     */
    public RC_Picture(int width, int height) {
   ...
   /**
     ...
     */
    public RC_Picture(RC_Picture picture) {
        width  = picture.width();
   ...
   /**
     ...
     */
    public RC_Picture(String filename) {
   ...
   /**
    ...
    public boolean equals(Object other) {
        ...
        RC_Picture that = (RC_Picture) other;
   ...
   /**
    ...
    public static void main(String[] args) {
        RC_Picture picture = new RC_Picture(args[0]);
